      ...
      <div className="flex-1 flex flex-col shrink-0 w-full">
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center gap-2.5 cursor-pointer">
            <img src={avatar_url} alt="ảnh avatar" className="w-8 sm:w-9 md:w-10 aspect-square rounded-full object-cover border-none" />
            <p className="text-sm sm:text-base text-blue font-semibold line-clamp-1">{name}</p>
          </div>
          {is_following ? 
            <div className="px-1.5 py-1.5 sm:px-2 sm:py-2 rounded-full font-semibold text-white text-xs bg-orange cursor-pointer">
              Following
            </div>
            : 
            <div className="px-1.5 py-1.5 sm:px-2 sm:py-2 rounded-full font-semibold text-orange bg-white text-xs border border-orange cursor-pointer">
              Follow
            </div>
          }
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-start items-center cursor-pointer">
            {is_liked ?
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-4 h-4 sm:w-5 sm:h-5 text-blue"><path fill="#3c5a9a" d="M305 151.1L320 171.8L335 151.1C360 116.5 400.2 96 442.9 96C516.4 96 576 155.6 576 229.1L576 231.7C576 343.9 436.1 474.2 363.1 529.9C350.7 539.3 335.5 544 320 544C304.5 544 289.2 539.4 276.9 529.9C203.9 474.2 64 343.9 64 231.7L64 229.1C64 155.6 123.6 96 197.1 96C239.8 96 280 116.5 305 151.1z"/></svg>
            :
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-4 h-4 sm:w-5 sm:h-5 text-blue"><path fill="#3c5a9a" d="M442.9 144C415.6 144 389.9 157.1 373.9 179.2L339.5 226.8C335 233 327.8 236.7 320.1 236.7C312.4 236.7 305.2 233 300.7 226.8L266.3 179.2C250.3 157.1 224.6 144 197.3 144C150.3 144 112.2 182.1 112.2 229.1C112.2 279 144.2 327.5 180.3 371.4C221.4 421.4 271.7 465.4 306.2 491.7C309.4 494.1 314.1 495.9 320.2 495.9C326.3 495.9 331 494.1 334.2 491.7C368.7 465.4 419 421.3 460.1 371.4C496.3 327.5 528.2 279 528.2 229.1C528.2 182.1 490.1 144 443.1 144zM335 151.1C360 116.5 400.2 96 442.9 96C516.4 96 576 155.6 576 229.1C576 297.7 533.1 358 496.9 401.9C452.8 455.5 399.6 502 363.1 529.8C350.8 539.2 335.6 543.9 320 543.9C304.4 543.9 289.2 539.2 276.9 529.8C240.4 502 187.2 455.5 143.1 402C106.9 358.1 64 297.7 64 229.1C64 155.6 123.6 96 197.1 96C239.8 96 280 116.5 305 151.1L320 171.8L335 151.1z"/></svg>}
            <p className="text-xs sm:text-base text-blue">{likes_count}</p>
          </div>
